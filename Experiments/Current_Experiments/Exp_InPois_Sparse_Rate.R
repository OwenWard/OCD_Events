#### Exp varying sparsity in the rate function,
#### Examine performance based on the expected/average number of 
#### events, by fixing rho and varying the ratesß
...
for(sim in 1:no_sims){
  ...
  ### need to vary MuA over simulations
  if(sim_id == 1){
...
saveRDS(results, file = here("Experiments",
                             ...
                             paste0("exp_inpois_nodes_vary_rate_nov_6_",
