...
inter_T <- 1
K <- 2
m_vec <- c(rep(100, 2), rep(200, 2), rep(500, 2))
...
results <- list()
m <- m_vec[sim_id]
m0_vec <- c( 100*c(1/4, 1/2),
             200*c(1/4, 1/2),
             500*c(1/4, 1/2))
m0_curr <- m0_vec[sim_id]

sparsity <- 5/m 
# prop of edges which can have events
...
saveRDS(results, file = here("Experiments",
                             "exp_results",
                             paste0("exp_14_april_21_rho_",
                                    100*sparsity, "_scale_", sim_id, ".RDS")))
