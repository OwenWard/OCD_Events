...
// [[Rcpp::export]]
Rcpp::List nonhomoHak_estimator(
	arma::mat alltimes,
	Rcpp::List A,
	int m,
	int K,
	...
	for (int n = 0; n < N; n++ ){
		...
		// paralist = update_nonhomo(tau, MuA, B, Pi, S, datamap, t_start, Tn, m, K, A, window, lam, eta);
...
Rcpp::List nonhomoHak_estimator_eff(
	...
	for (int n = 0; n < N; n++ ){
		...
		paralist = update_nonhomo_eff(tau, MuA, B, Pi, S, datamap, t_start, Tn, m, K, window, lam, eta, gravity);
		arma::mat tau_new = paralist["tau"], B_new = paralist["B"], S_new = paralist["S"];
		arma::cube MuA_new = paralist["MuA"];
		arma::rowvec Pi_new = paralist["Pi"];
		double lam_new = paralist["lam"];
...
// [[Rcpp::export]]
Rcpp::List nonhomoPois_estimator_update(
    arma::mat alltimes,
    Rcpp::List A,
    int m,
    int K,
