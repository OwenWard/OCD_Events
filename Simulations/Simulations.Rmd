...
```{r setup}
knitr::opts_knit$set(root.dir = "C:/Users/owenw/Documents/Github Local/OCD_Events")
```
...
results_hawkes_sim <- online_estimator_eff_revised(alltimes_hawkes, A, m, K, Time, dT=1, lam = 1, B, Mu, tau,inter_T = 10, is_elbo = F)
